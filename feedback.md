...
- No input validation or error handling for non-integer inputs — Implement try-except blocks or type checking to handle invalid inputs (e.g., strings, floats) gracefully with clear error messages.
...
- Implement try-except blocks or type checking to handle invalid inputs (e.g., strings, floats) gracefully with clear error messages.
